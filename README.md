...
Overview of inventory status via summary cards:
- Low Stock Items
- Expiring Soon
- Overstocked Items
- At-Risk Items
...
Automatically records stock changes when the quantity is updated.
**Detects:**
- Stock decrease &rarr; Estimated sales
- Stock increase &rarr; Restocking
